...
public class ApplicationConfig extends AbstractConfig {
    ...
    // application owner
    private String owner;//应用负责人，用于服务治理

    // application's organization (BU)
    private String organization;//组织名称，用于注册中心区分服务来源

    // architecture layer
    private String architecture;//用于服务封层对应的架构

    // environment, e.g. dev, test or production
    private String environment;//应用环境，不同环境使用不同的缺省值，以及作为只用于开发测试功能的限制条件。
